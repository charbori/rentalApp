<div class="cont-img-box">
    <div class="col-12">
        <div class="bd-example" id="img-box">
            <!-- 대표 이미지 -->
            <svg id="img_1" class="bd-placeholder-img img-thumbnail" width="100%" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Responsive image" preserveAspectRatio="xMidYMid slice" focusable="false">
                <image href="" height="170" width="170"/>
                <text x="50%" y="50%" fill="#dee2e6" dy=".3em">+</text>
            </svg>
            <!-- 이미지 생성 -->
            <svg id="img-add" class="bd-placeholder-img img-thumbnail" width="150" height="150" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera: 200x200" preserveAspectRatio="xMidYMid slice" focusable="false" onClick="addImage('2')">
                <rect width="100%" height="100%" fill="#868e96"/>
                <text x="50%" y="50%" fill="#dee2e6" dy=".3em">more</text>
            </svg>
        </div>
    </div>
</div>
