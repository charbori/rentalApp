...
@section('contents')
    ...
    <main id="map_list" class="container">
        <div class="col ml-3 mt-3">
            <span class="h3 text-dark">검색결과</span>
        </div>
    </main>
@stop
@section('masternav_extra_item')
    <li class="nav-item">
        <div class="input-group input-group-sm ml-3 mt-1">
            <input type="text" id="search_map_data" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
...
@section('javascript')
    ...
    function initMapList(value) {
        ...
        map_list_item = ['<div class="row mt-3">',
